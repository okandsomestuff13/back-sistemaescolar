...
from dev_sistema_escolar_api.models import EventosAcademicos, Maestros, Administradores, Alumnos, BearerTokenAuthentication
from dev_sistema_escolar_api.serializers import EventoAcademicoSerializer, ResponsableSerializer
